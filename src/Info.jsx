        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          >
            ...
            <div className="flex space-x-4 mt-8">
              <a href="https://github.com" className="text-blue-600 hover:text-blue-800 transition duration-300" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://linkedin.com" className="text-blue-600 hover:text-blue-800 transition duration-300" target="_blank" rel="noopener noreferrer">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 bg-blue-600 text-white p-4 rounded-lg shadow-lg">
                <p className="text-sm font-semibold">MERN Stack Developer</p>
              </div>
            </div>
          </motion.div>
        </div>
